...
* It's done when the HTML page has been linked with the external CSS style sheet.  done

* It's done when `Section 1` has a background color of purple and the text is yellow. done

* It's done when `Section 2` and `Section 3` have a background color of blue and the text is orange. done
